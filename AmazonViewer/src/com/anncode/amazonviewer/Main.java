 ...
 * <h1>Amazon Viewer</h1>
 * 
 * 	Amazon viewer es un programa que permite visualizar movies, series
 * 	con sus respectivos Chapters, Books, y Magazines. 
 * 	Te  permite generar reporters generales  y con fecha del d�a.
 * 
 * 	Existen algunas reglas como que todos los elementos pueden ser visualizados
 * 	excepto los Magazines.
 * 
 * 
 * 	
